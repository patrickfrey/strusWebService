...
const int ERROR_DOCUMENT_GET_CMD_ILLEGAL_STORAGE_DIR		= ERROR_DOCUMENT_GET_CMD + 1;
const int ERROR_DOCUMENT_GET_CMD_NO_SUCH_DATABASE			= ERROR_DOCUMENT_GET_CMD + 2;
const int ERROR_DOCUMENT_GET_CMD_CREATE_DATABASE_CLIENT		= ERROR_DOCUMENT_GET_CMD + 3;
const int ERROR_DOCUMENT_GET_CMD_CREATE_STORAGE_CLIENT		= ERROR_DOCUMENT_GET_CMD + 4;
const int ERROR_DOCUMENT_GET_CMD_CREATE_STORAGE_TRANSACTION = ERROR_DOCUMENT_GET_CMD + 5;
const int ERROR_DOCUMENT_GET_ILLEGAL_JSON					= ERROR_DOCUMENT_GET_CMD + 6;	
const int ERROR_DOCUMENT_GET_CMD_CREATE_METADATA_READER		= ERROR_DOCUMENT_GET_CMD + 7;
const int ERROR_DOCUMENT_GET_CMD_NO_SUCH_DOCUMENT			= ERROR_DOCUMENT_GET_CMD + 8;
const int ERROR_DOCUMENT_GET_CMD_CREATE_ATTRIBUTE_READER	= ERROR_DOCUMENT_GET_CMD + 9;
