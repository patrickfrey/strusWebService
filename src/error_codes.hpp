...
const int ERROR_DOCUMENT_INSERT_CMD_DOCID_REQUIRED			= ERROR_DOCUMENT_INSERT_CMD + 7;
const int ERROR_DOCUMENT_INSERT_TOO_BIG_POSITION			= ERROR_DOCUMENT_INSERT_CMD + 8;
