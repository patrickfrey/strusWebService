...
const int ERROR_INDEX_STATS_CMD_CREATE_DATABASE_CLIENT	= ERROR_INDEX_STATS_CMD + 1;
const int ERROR_INDEX_STATS_CMD_CREATE_STORAGE_CLIENT	= ERROR_INDEX_STATS_CMD + 2;
